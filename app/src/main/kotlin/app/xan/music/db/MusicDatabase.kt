...
import app.xan.music.db.daos.SpeedDialDao
...
import app.xan.music.db.entities.PlaylistSongMapPreview
...
import app.xan.music.db.entities.SortedSongAlbumMap
import app.xan.music.db.entities.SortedSongArtistMap
...
// Adds the @ColumnInfo(index = true) on event.timestamp (stats/history queries filter
// on timestamp ranges). Manual migration so existing installs keep their data —
// the fallback would otherwise destroy the library.
val MIGRATION_35_36 =
