                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: app.xan.music.platform.ProjectLinks.RELEASES
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        GitHubReleases.fetch(includePrereleases = true)
            .onSuccess { releases ->
                val targetRelease = releases.reduceOrNull { best, candidate ->
                ...
                val apk = targetRelease.assets.firstOrNull {
