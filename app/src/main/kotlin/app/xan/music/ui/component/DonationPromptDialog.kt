...
import app.xan.music.constants.DonationPromptDismissedKey
import app.xan.music.constants.DonationPromptLastShownKey
import app.xan.music.constants.FirstLaunchTimestampKey
    ...
    AlertDialog(
        ...
        confirmButton = {
            Column(
                ...
                Button(
                    onClick = {
                        uriHandler.safeOpenUri(context, SupporterUrl)
                        dismiss()
                    },
