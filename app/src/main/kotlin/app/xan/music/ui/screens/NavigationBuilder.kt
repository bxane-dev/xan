...
import app.xan.music.ui.utils.LocalNavAnimatedVisibilityScope
import androidx.compose.foundation.layout.Box
import androidx.compose.ui.Modifier
import app.xan.music.ui.utils.morphContainer
import app.xan.music.ui.utils.hasMorphSource
import app.xan.music.ui.utils.morphArtworkId
import app.xan.music.ui.screens.settings.HomeFeedOrderScreen
import app.xan.music.ui.screens.artist.ArtistAlbumsScreen
import app.xan.music.ui.screens.artist.ArtistItemsScreen
import app.xan.music.ui.screens.artist.ArtistScreen
import app.xan.music.ui.screens.artist.ArtistSongsScreen
import app.xan.music.ui.screens.equalizer.EqScreen
import app.xan.music.ui.screens.library.LocalFolderScreen
import app.xan.music.ui.screens.library.LocalMusicScreen
import app.xan.music.ui.screens.library.LibraryScreen
import app.xan.music.ui.screens.library.LocalSongsScreen
import app.xan.music.ui.screens.settings.SettingsScreen
import app.xan.music.ui.screens.playlist.AutoPlaylistScreen
import app.xan.music.ui.screens.playlist.CachePlaylistScreen
import app.xan.music.ui.screens.playlist.LocalPlaylistScreen
import app.xan.music.ui.screens.playlist.OnlinePlaylistScreen
import app.xan.music.ui.screens.playlist.TopPlaylistScreen
import app.xan.music.ui.screens.search.OnlineSearchResult
import app.xan.music.ui.screens.settings.AboutScreen
import app.xan.music.ui.screens.settings.AppearanceSettings
import app.xan.music.ui.screens.settings.CanvasSelection
import app.xan.music.ui.screens.settings.diy.PresetsScreen
import app.xan.music.ui.screens.settings.FontSelectionScreen
import app.xan.music.ui.screens.settings.GlassEffectSettings
import app.xan.music.ui.screens.settings.PlayerThemeScreen
import app.xan.music.ui.screens.settings.BackupAndRestore
import app.xan.music.ui.screens.settings.SpotifyScreen
import app.xan.music.viewmodels.SpotifyImportViewModel
import androidx.hilt.navigation.compose.hiltViewModel
import app.xan.music.ui.screens.settings.ContentSettings
import app.xan.music.ui.screens.settings.DiscordLoginScreen
import app.xan.music.ui.screens.settings.PlayerSettings
import app.xan.music.ui.screens.settings.LocalFoldersSettingsScreen
import app.xan.music.ui.screens.settings.ScanMusicScreen
import app.xan.music.ui.screens.settings.PrivacySettings
import app.xan.music.ui.screens.settings.RomanizationSettings
import app.xan.music.ui.screens.settings.AccountSettingsScreen
import app.xan.music.ui.screens.settings.StorageSettings
import app.xan.music.ui.screens.settings.ThemeScreen
import app.xan.music.ui.screens.settings.AiSettings
import app.xan.music.ui.screens.settings.integrations.DiscordSettings
import app.xan.music.ui.screens.settings.integrations.IntegrationScreen
import app.xan.music.ui.screens.settings.integrations.LastFMSettings
import app.xan.music.ui.screens.settings.integrations.ListenTogetherSettings
import app.xan.music.ui.screens.ambient.AmbientModeScreen
import app.xan.music.ui.screens.recognition.RecognitionScreen
import app.xan.music.ui.screens.recognition.RecognitionHistoryScreen
import app.xan.music.ui.screens.settings.UpdateSettings
import app.xan.music.ui.screens.wrapped.WrappedScreen
import app.xan.music.platform.updater.UpdateScreen
import app.xan.music.platform.changelog.ChangelogScreen
import app.xan.music.platform.commitscreen.CommitScreen
import app.xan.music.ui.screens.equalizer.axion.AxionEqScreen
...
fun NavGraphBuilder.navigationBuilder(
    ...
    sharedComposable("settings/spotify/web") {
        SpotifyScreen(navController, scrollBehavior, autoStartLogin = true)
    }
