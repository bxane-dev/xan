package app.xan.music.ui.screens.equalizer.axion
...
import app.xan.music.eq.data.FilterType
import app.xan.music.eq.data.ParametricEQBand
import app.xan.music.eq.data.SavedEQProfile
...
class AxionEqViewModel @Inject constructor(
    ...
    private val prefs = context.getSharedPreferences("xan_eq_prefs", Context.MODE_PRIVATE)
    ...
    val customProfiles = eqProfileRepository.profiles.map { profiles ->
        profiles.filter { it.isCustom && it.id != "xan_tuning" }
