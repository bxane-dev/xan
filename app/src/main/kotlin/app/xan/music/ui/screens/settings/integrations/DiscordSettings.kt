...
import app.xan.music.ui.utils.appTopBarWindowInsets
import app.xan.music.constants.DiscordAvatarKey
import app.xan.music.ui.utils.appTopBarWindowInsets
...
import app.xan.music.ui.utils.appTopBarWindowInsets
import app.xan.music.constants.DiscordInfoDismissedKey
import app.xan.music.ui.utils.appTopBarWindowInsets
import app.xan.music.constants.DiscordNameKey
import app.xan.music.ui.utils.appTopBarWindowInsets
...
import app.xan.music.ui.utils.appTopBarWindowInsets
import app.xan.music.constants.DiscordUsernameKey
import app.xan.music.ui.utils.appTopBarWindowInsets
                ...
                Material3SettingsGroup(
                    ...
                    items = listOf(
                        ...
                        Material3SettingsItem(
                            ...
                            description = {
                                Text(button2Text.ifEmpty { "Visit xan" })
                            },
                            trailingContent = {
                                Switch(
...
fun RichPresence(
    ...
    val activityLabel = when (activityType) {
        "playing" -> stringResource(R.string.discord_playing_xan)
        "watching" -> stringResource(R.string.discord_watching_xan)
        "competing" -> stringResource(R.string.discord_competing_xan)
        else -> stringResource(R.string.listening_to_xan)
    }
        ...
        Column(
            ...
            if (button2Visible) {
                val resolvedButton2 = if (song != null) {
                    DiscordRPC.resolveVariables(
                        button2Text.ifEmpty { "Visit xan" }, song
                    )
                } else {
                    button2Text.ifEmpty { "Visit xan" }
                }
                OutlinedButton(
                    onClick = {
                        val intent = Intent(
                            Intent.ACTION_VIEW,
                            "https://github.com/bxane-dev/xan".toUri()
                        )
                        context.startActivity(intent)
                    },
                    modifier = Modifier.fillMaxWidth(),
