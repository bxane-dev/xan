package app.xan.music.ui.theme
...
fun HeroTintedContent(
    ...
    // hero text colors below — same override xanTheme's own flatText
    ...
    // flatText is the same override xanTheme applies at the root; it has to
